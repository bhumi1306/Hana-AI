...
import 'package:hana_ai/widgets/loader.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _typingController = AnimationController(
      duration: const Duration(milliseconds: 50), // Speed of each character
      vsync: this,
    );
    _loadChatHistory();
  }
          ...
          children: [
            ...
            Expanded(
              child: isLoadingHistory
                  ? Center(
                child: LoadingHelper(screenHeight: screenHeight, screenWidth: screenWidth),)
                  : chatHistory.isEmpty
                  ? Center(
                child: Column(
            ...
            if (hasChat)
              Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    // Show typing indicator if typing and this is the extra item
                              ...
                              children: [
                                IconButton(
                                  ...
                                  style: IconButton.styleFrom(
                                    backgroundColor: isTyping?theme.colorScheme.tertiaryContainer:theme.colorScheme.primary,
                                  ),
                                  onPressed: () async{
                                    final prefs = await SharedPreferences.getInstance();
